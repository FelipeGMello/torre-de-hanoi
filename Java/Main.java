...
public class Main{
    ...
    private static Pilha[] torres = new Pilha[3];
    private static int contador = 0; //Conta as jogadas
    ...
    private static int jogada(Pilha atual, Pilha objetivo, Pilha auxiliar, int flag){
        int quant = 0;
    ...
    public static void main(String[] args) {
        inicializa(torres);
        Scanner input = new Scanner(System.in);
        System.out.println("Enter para proxima jogada ou digite ff(fast forward) para motrar todas as jogadas de uma vez\n");
        System.out.print("Ha o modo debug para ver como o programa move os discos. Ativar? (s/n) ");
