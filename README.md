...
## Sobre os programas
Há um programa em C que resolve o problema usando pilhas e há um em Java, que resolve o problema também utilizando uma lógica de pilhas, mas utilizando arrays. Não há métricas de velocidade de resolução.
